...
IRQn_Type nrfx_get_irq_number(void const * p_reg){
  ...
  /* CM33S */
    ...
    return TIMER00_IRQn;
  } else if (IS_PERIPHERAL_REG(p_reg, EGU, 00, _S)) {
    return EGU00_IRQn;
  } else if (IS_PERIPHERAL_REG(p_reg, CRACEN, , _S)) {
    return CRACEN_IRQn;
  } else if (IS_PERIPHERAL_REG(p_reg, USBHS, , _S)) {
    return USBHS_IRQn;
  } else if (IS_PERIPHERAL_REG(p_reg, SPU, 10, _S)) {
    return SPU10_IRQn;
  } else if (IS_PERIPHERAL_REG(p_reg, TIMER, 10, _S)) {
    ...
    return GRTC_0_IRQn;
    /* Note GRTC has 4 interrupts */
  } else if (IS_PERIPHERAL_REG(p_reg, TDM, , _S)) {
    return TDM_IRQn;
  } else if (IS_PERIPHERAL_REG(p_reg, UARTE, 23, _S)) {
    return SERIAL23_IRQn;
  } else if (IS_PERIPHERAL_REG(p_reg, UARTE, 24, _S)) {
    return SERIAL24_IRQn;
  } else if (IS_PERIPHERAL_REG(p_reg, TAMPC, , _S)) {
    return TAMPC_IRQn;
  } else if (IS_PERIPHERAL_REG(p_reg, SPU, 30, _S)) {
    return SPU30_IRQn;
